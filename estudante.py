...
class ExtratorDeEstudante(BaseModel):
    estudante:str = Field("Nome do estudante informado, sempre em letras minusculas. Exemplo: joão, carlos, joana, carla.")
...
class PerfilAcademicoDeEstudante(BaseModel):
    ...
    resumo:str = Field("Resumo das principais características desse estudante de forma a torná-lo e um ótimo potencial de estudante para faculdades. Exemplo: só este estudante tem bla bla bla")
...
class PerfilAcademico(BaseTool):
    ...
    description = """Cria um perfil acadêmico de um estudante. Esta ferramenta requer com entrada todos os dados do estudante.
...
Você tem que buscar os dados do estudante antes de me invocar."""
    ...
    def _run(self, input: str) -> str:
        ...
        template = PromptTemplate("""-Formate o estudante para seu perfil acadêmico.
- Com dados, identifique as opções de universidades sugeridas e cursos compativeis com o interesse do aluno.
